...
<a class="d-flex align-items-center" href="#">
          <img src="images/food1.jpg" alt="Logo" style="width: 50px; height: 50px; border-radius:50%;"><span class="text-light text-decoration-none">user name</span>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav mx-auto"> <!-- This centers the links on larger screens -->
      ...
      <li class="nav-item">
        <a class="nav-link d-flex align-items-center" href="users/login.php"><span>login</span> </a>
      </li>
    </ul>
  </div>
</nav>
